...
In order to unlearn multiple entities, you can run the `./scripts/unlearn_multiple_entities.sh` bash script, which unlearns multiple entities in sequence, saving 


In order to easily run a full experiment for a model, you can run `./scripts/unlearn_entity.sh [bs|be|rs|re]` bash script, which unlearns multiple entities in sequence. Be sure to update the configuration section of this script to reflect where the models and data are stored. 
